...
filename_labels = 'labels_1700_29_1200_800.h5'
...
def main(argv):
    ...
    n_train_exact = size_of_fold*(N_IMG)          #exact number of trainingspixel for unrotated case

    with h5py.File(filename_labels,'r') as train_lab_f: #trainingsLabels.h5
